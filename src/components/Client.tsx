...
const ClientContainer = styled.div`
  display: flex;
  width: 100%; /* 너비를 100%로 설정하여 유연하게 반응하도록 함 */
  height: 59px; /* 헤더의 높이를 고정 */
  position: relative;
...
// ... (BackgroundImage, WindowControls, ControlButtons, SteamLogo, FriendsSection, FriendsBackground, FriendsIcon, UserSection, UserBackground, UserContent, UserAvatar, UserName, UserBalance, DropdownArrow 스타일은 기존과 동일합니다)
// 아래는 생략하지 않은 전체 스타일 코드입니다.
