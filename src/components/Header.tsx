        ...
        <ControlButtons>
          <MinimizeButton onClick={handleMinimize}>
            <div
              dangerouslySetInnerHTML={{
                __html:
                  '<svg id="I1024:4534;1009:6740;333:2384" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" class="minimize-icon" style="width: 25px; height: 25px"> <g clip-path="url(#clip0_1209_518)"> <path d="M7.29167 11.6265H17.7083C18.2812 11.6265 18.75 12.0952 18.75 12.6681C18.75 13.241 18.2812 13.7098 17.7083 13.7098H7.29167C6.71875 13.7098 6.25 13.241 6.25 12.6681C6.25 12.0952 6.71875 11.6265 7.29167 11.6265Z" fill="#76808C"></path> </g> <defs> <clipPath id="clip0_1209_518"> <rect width="25" height="25" fill="white"></rect> </clipPath> </defs> </svg>',
              }}
            />
          </MinimizeButton>
          <MaximizeButton onClick={handleMaximize}>
            <div
              dangerouslySetInnerHTML={{
                __html:
                  '<svg id="I1024:4534;1009:6740;333:2387" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" class="copy-icon" style="width: 25px; height: 25px"> <g clip-path="url(#clip0_1209_521)"> <path d="M8.31931 5.05615H19.9344C21.0959 5.05615 21.3423 5.68289 21.3423 6.4489V15.5018C21.3423 15.8848 21.2191 16.3496 20.6383 16.3496C20.0576 16.3496 19.9344 15.8848 19.9344 15.5018V7.14528C19.9344 6.76227 19.4593 6.4489 18.8785 6.4489H8.31931C7.73856 6.4489 7.2634 6.13554 7.2634 5.75253C7.2634 5.36952 7.73856 5.05615 8.31931 5.05615ZM5.15158 7.84169H16.7667C17.9282 7.84169 18.5265 8.46843 18.5265 9.23444V18.9837C18.5265 19.7497 17.9282 20.3765 16.7667 20.3765H5.15158C3.99006 20.3765 3.74364 19.7497 3.74364 18.9837V9.23444C3.74364 8.46843 3.99006 7.84169 5.15158 7.84169ZM6.20749 18.9837H15.7108C16.2915 18.9837 16.7667 18.6703 16.7667 18.2873V9.93082C16.7667 9.54781 16.2915 9.23444 15.7108 9.23444H6.20749C5.62674 9.23444 5.15158 9.54781 5.15158 9.93082V18.2873C5.15158 18.6703 5.62674 18.9837 6.20749 18.9837Z" fill="#76808C"></path> </g> <defs> <clipPath id="clip0_1209_521"> <rect width="25" height="25" fill="white" transform="matrix(-1 0 0 1 25 0)"></rect> </clipPath> </defs> </svg>',
              }}
            />
          </MaximizeButton>
          <CloseButton onClick={handleClose}>
            <div
              dangerouslySetInnerHTML={{
                __html:
                  '<svg id="I1024:4534;1009:6740;333:2390" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" class="close-icon" style="width: 25px; height: 25px"> <g clip-path="url(#clip0_1209_524)"> <path d="M19.0625 5.94792C18.6562 5.54167 18 5.54167 17.5937 5.94792L12.5 11.0312L7.40625 5.9375C7 5.53125 6.34375 5.53125 5.9375 5.9375C5.53125 6.34375 5.53125 7 5.9375 7.40625L11.0312 12.5L5.9375 17.5937C5.53125 18 5.53125 18.6562 5.9375 19.0625C6.34375 19.4687 7 19.4687 7.40625 19.0625L12.5 13.9687L17.5937 19.0625C18 19.4687 18.6562 19.4687 19.0625 19.0625C19.4687 18.6562 19.4687 18 19.0625 17.5937L13.9687 12.5L19.0625 7.40625C19.4583 7.01042 19.4583 6.34375 19.0625 5.94792Z" fill="#76808C"></path> </g> <defs> <clipPath id="clip0_1209_524"> <rect width="25" height="25" fill="white"></rect> </clipPath> </defs> </svg>',
              }}
            />
          </CloseButton>
        </ControlButtons>
